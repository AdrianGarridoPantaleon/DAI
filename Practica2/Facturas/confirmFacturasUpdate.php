...
<body>
    <?php
        ...
        $SentenciaSQL = ("UPDATE detalle_factura SET Numero_Factura = '$nf', Referencia = $ref, Unidades = $unidades WHERE Numero_Factura = '$nf'");
        ...
        $SentenciaSQL = ("UPDATE facturas SET Numero_factura = '$nf', Matricula = '$mat', Mano_Obra = $mo, Precio_Hora = $ph, Fecha_Emision = '$fe', Fecha_Pago = '$fp', Base_Imponible = $bi, IVA = $iva, Total = $total WHERE Numero_Factura = '$nf'");
